    ...
    Surface(
        ...
        Row(
            ...
            Cart(
                ...
                onClicked = { navController.navigate("checkout") }, // Navigate to Checkout screen
                modifier = Modifier.weight(weight = 1f)
            )
        }
    }
...
private fun SelectorButton(
    ...
    Surface(
        modifier = modifier.size(36.dp), // Adjust size for better touch area
        shape = CircleShape,
        ...
        Box(
            modifier = Modifier
                .fillMaxSize()
                .clickable(onClick = { onClicked() }), // Ensure click triggers the callback
            contentAlignment = Alignment.Center
        ) {
            Icon(
                painter = painterResource(id = iconRes),
                contentDescription = null,
                modifier = Modifier.size(20.dp) // Adjust icon size for better visibility
            )
        }
    }
}
    ...
    Surface(
        ...
        Box(
            ...
            Column(
                ...
                Text(
                    text = "Add to Cart and click to checkout",
